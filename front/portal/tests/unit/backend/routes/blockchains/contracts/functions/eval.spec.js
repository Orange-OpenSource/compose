...
describe('Eval function endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  });
  ...
  test('Do not authorize the access if not authenticated', function(done){
    api.post('/api/blockchains/abfTestnet/contracts/0x27B2e58e6e96b3DCCaA2e9f9c1627CB683c9e4Ed/functions/set/eval')
  ...
  test('Eval function', function(done){
    const mockApiResponse = {
      data: {
        "hash":"0x284091114325c800d9df388c48c413220202c8067dd571e443cbe254fd3a1179"
      }
    };
