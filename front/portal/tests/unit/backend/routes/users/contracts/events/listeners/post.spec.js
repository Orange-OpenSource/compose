...
describe('Create listener endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  });
  ...
  test('Do not authorize the access if not authenticated', function(done){
    api.post('/api/users/me/contracts/04be0470-20af-4baa-8726-130bce0b98e8/events/NewStore/webhooks')
  ...
  test('Create listener with user id', function(done){
    const mockApiResponse = {
      data: eventListeners.list[0]
    };
    ...
    api.post('/api/users/f5453f60-2390-48cc-9caa-50c6d143f400/contracts/04be0470-20af-4baa-8726-130bce0b98e8/events/NewStore/webhooks')
      .send({
        url: "http://localhsot:9000/test",
        blockchain: "local"
      })
