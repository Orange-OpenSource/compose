...
describe('Create wallet endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  });
  ...
  test('Create wallet', function(done){
  ...
  test('Create wallet with user id', function(done){
    const mockApiResponse = {
      data: wallets.list[0]
    };
    ...
    api.post('/api/users/f5453f60-2390-48cc-9caa-50c6d143f400/wallets')
      .send({
        "name": "Test 1",
        "blockchain": "abfTestnet",
        "password": "Test"
