...
describe('Get wallet endpoint', () => {
  ...
  test('Do not authorize the access if not authenticated', function(done){
    api.get('/api/users/me/wallets/0xE782cfA233b9887bFdE14988302eF945aECb98dC')
  ...
  test('Get wallet with user id', function(done){
    const mockApiResponse = {
      data: wallets.list[0]
    };
    ...
    api.get('/api/users/f5453f60-2390-48cc-9caa-50c6d143f400/wallets/0xE782cfA233b9887bFdE14988302eF945aECb98dC')
      .expect('Content-Type', /json/)
      .expect(200)
      .end(function(err, res){
        if (err) return done(err);
