...
describe('Delete wallet endpoint', () => {
  beforeEach(() => {
    jest.clearAllMocks()
  });
  ...
  test('Do not authorize the access if not authenticated', function(done){
    api.delete('/api/users/me/wallets/0xE782cfA233b9887bFdE14988302eF945aECb98dC')
  ...
  test('Delete wallet', function(done){
  ...
  test('Delete wallet with user id', function(done){
    const mockApiResponse = {
      data: null
    };
    ...
    api.delete('/api/users/f5453f60-2390-48cc-9caa-50c6d143f400/wallets/0xE782cfA233b9887bFdE14988302eF945aECb98dC')
      .expect(204)
      .end(function(err, res){
        if (err) return done(err);
        done();
