...
describe('List applications endpoint', () => {
  ...
  test('Get applications list', function(done){
  ...
  test('Get applications list with user id', function(done){
    const mockApiResponse = {
      data: applications.list
    };
    ...
    api.get('/api/users/f5453f60-2390-48cc-9caa-50c6d143f400/applications')
      .expect('Content-Type', /json/)
      .expect(200)
      .end(function(err, res){
        if (err) return done(err);
